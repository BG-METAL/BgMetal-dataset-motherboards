...
def contar_imagenes_en_carpeta(ruta_carpeta):
    """
    Cuenta las imágenes en una carpeta específica, evitando duplicados
    causados por la insensibilidad a mayúsculas y minúsculas en las extensiones.
    ...
    # Usar un conjunto para almacenar las rutas de los archivos y evitar duplicados
    archivos_unicos = set()
    ...
    for formato in formatos_imagen:
        ...
        for archivo in archivos_encontrados:
            archivos_unicos.add(archivo)
    
    # El tamaño del conjunto es el número total de archivos únicos
    return len(archivos_unicos)
